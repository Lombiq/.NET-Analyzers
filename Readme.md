...
- Looking for something similar for JavaScript, CSS, and even Markdown and YAML? Check out the [Asset Linting workflow](https://github.com/Lombiq/GitHub-Actions/blob/dev/Docs/Workflows/Productivity/AssetLinting.md) of our Lombiq GitHub Actions project.
