...
Get-ChildItem bin\Debug | Copy-Item -Destination lib -Recurse -filter Lombiq.Analyzers.dll
Get-ChildItem bin\Debug | Copy-Item -Destination lib -Recurse -filter Lombiq.Analyzers.pdb
